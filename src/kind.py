...
from Additives import spherical, linear, bubble, swirl, expinj, sinmoche, pdj
...
class ImageHolder():
    ...
    def __post_init__(self):
        ...
        fm = FunctionMapping(l, colors, weights, additives, Ax, Ay, probabilites, final=True)
        ...
        fm2 = FunctionMapping(l, colors, weights, additives, Ax, Ay, probabilites, final=True)


        self.vh = VH([fm, fm2],15,30, 150000)
...
if __name__ == "__main__":
    ...
    do_video_with_image_from_parameters(666)